...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdUser.permissions'
        db.alter_column('facebook_ads_aduser', 'permissions', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'AdUser.permissions'
        db.alter_column('facebook_ads_aduser', 'permissions', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10))
