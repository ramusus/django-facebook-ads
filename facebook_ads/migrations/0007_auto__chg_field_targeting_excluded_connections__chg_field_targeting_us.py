...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Targeting.excluded_connections'
        db.alter_column('facebook_ads_targeting', 'excluded_connections', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=100))

        # Changing field 'Targeting.user_adclusters'
        db.alter_column('facebook_ads_targeting', 'user_adclusters', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Targeting.cities'
        db.alter_column('facebook_ads_targeting', 'cities', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Targeting.friends_of_connections'
        db.alter_column('facebook_ads_targeting', 'friends_of_connections', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=100))
